...
function Navbar() {
    return (
        <nav className="navbar">
            ...
            {/* Links to 3 different nav sites */}
            ...
            {/* Logo for account info/log in on the right */}
            <div className="navbar_account">
                <img src="https://thumbs.dreamstime.com/z/user-icon-member-login-vector-isolated-white-background-form-155134186.jpg" alt="Account" />
            </div>
        </nav>
    );
};
